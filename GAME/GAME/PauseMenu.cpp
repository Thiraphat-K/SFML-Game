...
{
	this->PmenuTexture[0].loadFromFile("Object/");
	...
	this->Pmenupic[0].setPosition(455, 415);
	...
	this->PmenuTexture[1].loadFromFile("Object/");
	...
	this->Pmenupic[1].setPosition(425, 590);

	this->PmenuTexture[2].loadFromFile("Object/");
	...
	this->Pmenupic[2].setPosition(590, 550);
